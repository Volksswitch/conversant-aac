...
const HELP = {
  ...
  "controls": {
    ...
    "cleanupSamplesView": "Recent examples where tidying up rewrote the words that were heard. These stay on this device and are never sent.",
  ...
  "sections": {
    ...
    "pardon": "What the app says when you tap the button asking the other person to say that again.",
    ...
    "declineClosing": "What you say to keep a conversation going when the other person has started to say goodbye.",
    ...
    "cleanupSamples": "Examples where tidying up changed the wording of what was heard, not just the punctuation. Stays on this device.",
