...
const HELP = {
  ...
  "controls": {
    ...
    "exportSettingsBtn": "Saves your settings into their own file, to move to another device of the same kind. No keys are ever included.",
    "importSettingsBtn": "Loads settings from a file you choose, replacing every setting here. Your data and your keys are left alone.",
