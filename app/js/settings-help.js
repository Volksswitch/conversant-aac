...
const HELP = {
  ...
  "controls": {
    ...
    "exportDataBtn": "Saves everything on this device into one file: your answers, people, buttons, conversations, settings and profiles. No keys.",
    "importDataBtn": "Loads everything back from a backup you choose. Anything tied to a different device, like the screen edge margin, is left as it is here.",
    ...
    "moreScopeSelect": "When a band has more buttons than fit, whether More shows the rest in that band alone, or across the whole panel.",
  ...
  "sections": {
    ...
    "backupTransfer": "Saves everything on this device to one file, or puts it back from one. Your keys are never included.",
