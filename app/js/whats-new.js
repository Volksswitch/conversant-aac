...
const RELEASE_NOTES = {
  "0.6.2": [
    {
      "for": "computer",
      "note": "The app no longer records an error when it asks permission to use your data folder. Your browser asks you to confirm the folder each time you start the app, and if you took more than six seconds to answer, the app decided its own storage had stopped responding, noted an error, and carried on without the folder. It now waits for your answer however long you take. If you have been seeing \"storage warm-up did not finish\" in the error log at Settings → About, that is what it was, and nothing was actually wrong."
    }
  ],
  "0.6.1": [
