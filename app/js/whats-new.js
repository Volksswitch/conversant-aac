...
const RELEASE_NOTES = {
  "0.6.3": [
    ...
    "The app now uses the whole screen. A new \"Use the whole screen\" setting on Settings → General, on to begin with, hides the browser and the taskbar so the conversation gets the extra height — about a tenth more room top to bottom. Turn it off if you have a keyguard cut for the smaller layout, because filling the screen moves every button.",
