...
boldPara("The decision: change the question rather than choose a side. ", "The instrument does not ask \"which of these sounds like you?\" (descriptive, and Section 3.3 says they cannot answer it accurately) nor \"which would you rather be?\" (aspirational, and it drifts without a floor). It asks:"),
codeBlock(`"Which of these would you be happy to have said?"`),
...
boldPara("One question left open for decision at build time. ", "Should tapping a blank cell open the editor? It is the obvious affordance and it makes the invitation real rather than decorative. It also places an entrance to Settings on the conversation surface, which cuts against the standing scoping decision that nothing be added to the conversation UI that could slow or trip someone up. The blank cells are keyguard-honest either way, since the grid does not change."),
emptyPara(),
...
boldPara("Item shape. ", "A partner turn, then three or four candidate replies that hold content constant and vary on exactly one dimension, and the question \"which of these would you be happy to have said?\" Every item offers \"any of these\" and \"none of these\" so a weak preference is recorded as weak rather than forced into a verdict."),
emptyPara(),
...
boldPara("The instrument is the Phase-1 instrument, put to the partner. ", "Per Section 5.4, a partner can answer about their own relationship with the user, which is precisely this data. The same items, reworded from \"would you be happy to have said\" to \"does this sound like how he talks with you,\" produce edge attributes directly, from the person best placed to supply them — with all four constraints in 5.4 in force."),
