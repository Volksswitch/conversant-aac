...
const doc = new Document({
    ...
    sections: [{
        ...
        children: [
            ...
            para(`That last point is a timing question rather than a sequence question, so this chart can only state it. Figure 3, in section 5, is where it is drawn: the same pause with the delay measured out along a time line, and Figure 4 beside it showing what changes when the other person carries on.`),
