        ...
        children: [
            ...
            simpleTable(
                ...
                [
                    ...
                    ["Flex", "Phrases filtered by the partner and the place currently selected", "Only this band, and only when a selection changes"],
            ...
            para("Feeling sits in the Context band because it never speaks, but it does not filter the Flex band. Only the partner and the place do that."),
            ...
            heading2("5.3 How the band is filled"),
            ...
            heading2("5.4 The one ordering promise, and the idea that was dropped"),
...
,
            ...
            numBold("A prototype of the bands, before anything is committed to. ", "How big each band should be, and whether a band that reorders itself between situations is tolerable, need to be seen and tapped rather than argued about. A throwaway page showing a Flex band with real phrases in it will settle in an afternoon what a document cannot settle at all.", "build"),
