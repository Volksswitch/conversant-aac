...
const doc = new Document({
    ...
    sections: [{
        ...
        children: [
            ...
            heading2("5.3 Standing roles, which is what makes swapping survivable"),
            ...
            heading2("5.4 Where the bands sit"),
            ...
            simpleTable(
                ...
                [
                    ...
                    ["Choice chips", "Today they take the leading cells of the whole panel and push everything along, so the plumbing is what gets displaced", "Confine them to the front of the context band. This is a fix to current behavior as much as a requirement of the new one"],
            ...
            numBold("How big the context band should be. ", "Too small and the feature is a novelty; too large and the plumbing gets squeezed. This wants a real panel in front of a real tester rather than a number chosen here.", "open"),
