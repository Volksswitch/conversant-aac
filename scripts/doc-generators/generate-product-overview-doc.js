...
const doc = new Document({
    ...
    sections: [{
        ...
        children: [
            ...
            bullet("Age 18 or older, and holding legal capacity (the higher age limit and the capacity requirement reflect the availability of suitable text-to-speech voices, the age-appropriateness of AI-generated conversational content, and the fact that the app speaks aloud in the user’s own name to real people — which is a decision the user should be free to make for themselves rather than have made on their behalf; expansion to younger users is a future goal)"),
            ...
            heading2("Legal Capacity"),
            para("The legal standing to make one’s own decisions and commitments, rather than having them made on one’s behalf by a parent, guardian, or conservator. It normally arrives with the age of majority — 18 in most of the United States — and can be limited by a court-appointed guardianship or conservatorship. Conversant AAC asks that the user hold it because of what the app does on their behalf: it speaks aloud in their name to real people, keeps a personal profile on their device, and runs on an AI account billed to them. Those are choices a person should be free to make for themselves."),
