...
const doc = new Document({
    ...
    sections: [{
        ...
        children: [
            ...
            lead("What is not yet known, and it is the part that decides it. ",
                "Whether the quality and the delay are good enough on a tablet rather than a desktop; whether a first-run download of that size is acceptable to a user who just wants to talk; and how a local voice compares with a paid one when heard side by side. None of that is settled by anything in this document, and it is exactly the sort of question the bench exists to answer - it would need a local option added to it, which is a piece of work rather than a setting."),
